...
print('++++++++++++++++++++++')
for _ in range(100):
    print('tf :', container_classification.get_training_features()[:, -1, :])
    print('tt :', container_classification.get_training_targets())
    # print('cf :', container_classification.get_cv_features()[0][0])
    # print('ct :', container_classification.get_cv_targets()[0][0])
